    ...
    crates = {
      ...
      "ledger-crypto-helpers" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "b7b401d0be38bdea30ffc150dfdb7b1e362b9057";
          sha256 = "0q2qxvcvl2zc9cz9368qlbizrshmsrh03ij35n1fjqs9jdh4ias9";
        };
        dependencies = [
          {
            name = "arrayvec";
      ...
      "ledger-prompts-ui" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "5b29e0d4d50e84e880cba3e9630d8f93948a842e";
          sha256 = "0px1bk00avsif5aqa68269b46nvj3rl504vnlkvq9bbw4zk67qrj";
        };
        dependencies = [
          {
            name = "arrayvec";
